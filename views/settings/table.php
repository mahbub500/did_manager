...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'did-manager' ),
		'products'			=> __( 'Products', 'did-manager' ),
		'order_total'		=> __( 'Order Total', 'did-manager' ),
		'commission'		=> __( 'Commission', 'did-manager' ),
		'payment_status'	=> __( 'Payment Status', 'did-manager' ),
		'time'				=> __( 'Time', 'did-manager' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'did-manager' ),
		'draft'		=> __( 'Draft', 'did-manager' ),
	],
];
